...
parser.add_argument("--no_serverAuth", action="store_true",
                    help="Server sends a certificate without serverAuth extendedKeyUsage extension")
...
parser.add_argument("--curve", help="ECC curve to advertise for TLS 1.3 (ex: secp256r1...")
parser.add_argument("--psk",
                    help="External PSK for symmetric authentication (for TLS 1.3)")  # noqa: E501
